...
<head>
    ...
    <title>Ruimteobject Bewerken</title>
...
<body>
    <main>
        ...
        <?php elseif ($spaceObject): ?>
            <form method="POST" action="space_objects_update.php?id=<?= $spaceObject->getId(); ?>" enctype="multipart/form-data">
                <div class="form-group">
                    <label for="name">Naam</label>
                    <input type="text" id="name" name="name" value="<?= htmlspecialchars($spaceObject->getName()); ?>" required>                
                </div>

                <div class="form-group">
                    <label for="description">Beschrijving</label>
                    <textarea id="description" name="description" required><?= htmlspecialchars($spaceObject->getDescription()); ?></textarea>
                </div>

                <div class="form-group">
                    <label for="type">Type</label>
                    <input type="text" id="type" name="type" value="<?= htmlspecialchars($spaceObject->getType()); ?>" required>
                </div>

                <div class="form-group">
                    <label for="discovered_date">Ontdekkingsdatum</label>
                    <input type="date" id="discovered_date" name="discovered_date" value="<?= htmlspecialchars($spaceObject->getDiscoveredDate()); ?>" required>
                </div>
                ...
                <fieldset class="form-group">
                    ...
                    <div id="url" class="tab-content active">
                        <div class="form-group">
                            ...
                            <input type="url" id="file_url" name="file_url" value="<?= htmlspecialchars($spaceObject->getFileUrl()); ?>" placeholder="https://example.com/image.jpg" onchange="previewImageUrl(this.value)">
